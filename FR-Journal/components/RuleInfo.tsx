          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0f0f0f] border border-red-900/30 rounded-2xl p-6 h-full shadow-inner shadow-red-900/10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 group/item">
                  <span className="flex-shrink-0 w-12 h-12 flex items-center justify-center bg-[#1a1a1a] border border-red-900/20 rounded-xl text-2xl font-black text-white group-hover/item:bg-red-900/
